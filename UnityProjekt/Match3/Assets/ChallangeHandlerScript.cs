...
//Level 27
        ...
        Challange17.Description = "Destroy " + Challange17.goal + " kiwis!";
        Challange17.id = 4;
        ...
        Challange18.Description = "Destroy " + Challange18.goal + " strawberrys!";
        Challange18.id = 5;
        Challange18.reward = (Challange18.goal * t5Multiplicator) + Random.Range(randMin, randMax);
        Challange18.done = 0;
        //max Challange = 18
    }
